...
def parse_args():
    ...
    parser.add_argument('-m', '--model', type=str, default='laplace', help='filter to use - Laplace or Sobel')
...
if __name__ == '__main__':
    ...
    for image_path in find_images(args.images):
        ...
        blur_map, score, blurry = estimate_blur(image, threshold=args.threshold, model=args.model)
    ...
    if save_path is not None:
        ...
        with open(save_path, 'w') as result_file:
            data = {'images': args.images, 'threshold': args.threshold, 'model': args.model, 'fix_size': fix_size, 'results': results}
